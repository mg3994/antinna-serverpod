...
class EndpointRtmpDestination extends _i2.EndpointRef {
  ...
  _i3.Future<String> getRelayStatus(String streamId) =>
      caller.callServerEndpoint<String>(
        'rtmpDestination',
        'getRelayStatus',
        {'streamId': streamId},
...
class EndpointRecordingSession extends _i2.EndpointRef {
  ...
  _i3.Future<_i8.RecordingSession> startRecording(String streamId) =>
      caller.callServerEndpoint<_i8.RecordingSession>(
        'recordingSession',
        'startRecording',
        {'streamId': streamId},
      );

  _i3.Future<_i8.RecordingSession?> stopRecording(int recordingId) =>
      caller.callServerEndpoint<_i8.RecordingSession?>(
        'recordingSession',
        'stopRecording',
  ...
  _i3.Future<List<_i8.RecordingSession>> listRecordings(String streamId) =>
      caller.callServerEndpoint<List<_i8.RecordingSession>>(
        'recordingSession',
        'listRecordings',
        {'streamId': streamId},
      );
