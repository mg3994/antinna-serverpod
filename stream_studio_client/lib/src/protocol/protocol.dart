...
import 'stream_metadata.dart' as _i8;
import 'package:stream_studio_client/src/protocol/overlay_preset.dart' as _i9;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.StreamMetadata) {
      return _i8.StreamMetadata.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i8.StreamMetadata?>()) {
      return (data != null ? _i8.StreamMetadata.fromJson(data) : null) as T;
    }
    if (t == List<_i9.OverlayPreset>) {
      return (data as List)
              .map((e) => deserialize<_i9.OverlayPreset>(e))
              .toList()
          as T;
    }
    try {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i8.StreamMetadata => 'StreamMetadata',
      _ => null,
    };
  }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'StreamMetadata') {
      return deserialize<_i8.StreamMetadata>(data['data']);
    }
