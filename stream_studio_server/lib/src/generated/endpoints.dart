...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'overlayPreset': _i4.OverlayPresetEndpoint()
        ..initialize(
          server,
          'overlayPreset',
          null,
    ...
    connectors['overlayPreset'] = _i1.EndpointConnector(
      name: 'overlayPreset',
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['overlayPreset'] as _i4.OverlayPresetEndpoint)
                      .savePreset(
                        session,
                        params['preset'],
                      ),
        ),
        'listPresets': _i1.MethodConnector(
          name: 'listPresets',
          params: {
